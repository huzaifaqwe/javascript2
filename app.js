...
// alert(certification)
                    ...
                    //  Chapter # 2   Variable For Strings  .5

// var pizza = "PIZZA"
// var arr = ["PIZZA"]
// for(var i = 1;i<pizza.length; i++){
//         arr[i] = pizza.slice(0,-i)
...
// document.write("The area is:" + " " + area + "<br/>" );
                            ...
                            // Chapter # 5  Math Expressions .13

// var favSnacks = "Super crips"
// var currentAge = 16
// var estAge = 89
// var noOfSnacks = 4
// var calc = (89-16)*4;
// document.write("Favorite Snacks :" + " " + favSnacks + " <br>")
// document.write("Current Age :" + " " + currentAge + "<br>")
// document.write("Estimated Maximum Age : " + " " + estAge + " <br>")
// document.write("Amount of snacks per day: " + " " + noOfSnacks + " <br>")
// document.write("You will need " + calc + " lays to last until you ripe old age " + " " + estAge)
...
//                                 Chapter # 9 to 11 User Ipnut and Conditional Statement.10
...
//                                 Chapter # 9 to 11 User Ipnut and Conditional Statement.11
...
//                                 CHAPTER # 12 TO 13 (IF ELSE and ELSE IF STATEMENTS, TESTING SETS OF CONDITIONS)
...
//                    Chapter # 12 to 13 If else and else if statements, testing sets of conditions . 3
...
// var stringArra = ["Ali","shazeel","sana","Aziz"]
// alert(stringArra)
...
// var cityNames = ["Karachi","multan","Lahore","Quetta","Isalamabad","Murree"];
...
// var arraays = ["My","name","is","huzaifa"];
...
//  var brands = ["Apple", "Samsung", "infinix", "huwai", "nokia", "sony"]
...
// var arr = [["ahmad",30,"Male"],["huzaifa",17,"Male"],["kiran",33,"Female"]]
...
//     document.write("<h1>The smallest Number is " + separate2 + "</h1>") 
                        ...
                        //    Chapter # 17 to 20 Arrays and Loops . 10
